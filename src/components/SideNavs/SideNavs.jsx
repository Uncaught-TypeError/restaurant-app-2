  ...
  return (
    <div className='fixed text-black'>
        ...
        <div className='fixed top-[90%] xl:left-[250px] md:left-[100px] left-[1rem]'>
            <img src={isHovered ? images.egg2 : images.egg1} className='h-12' onMouseEnter={handleHover}
        ...
        <div className='fixed top-[90%] xl:right-[200px] md:right-[100px] right-[1rem]'>
            <img src={isHovered ? images.msg1 : images.msg2} className='h-11' onMouseEnter={handleHover}
            onMouseLeave={handleMouseLeave} />
        </div>
    </div>
  )
